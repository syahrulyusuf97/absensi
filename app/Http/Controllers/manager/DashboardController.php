...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        return view('manager.dashboard.dashboard')->with(compact('total_absen_masuk', 'total_absen_pulang', 'total_absen_masuk_tepat', 'total_absen_masuk_tidak_tepat', 'total_absen_pulang_tepat', 'total_absen_pulang_tidak_tepat', 'izin_sakit', 'izin_cuti_pending', 'izin_cuti_approved', 'izin_cuti_rejected'));
    }
    ...
    public function profil()
    {
        ...
        return view('manager.profile.index')->with(compact('day', 'month', 'year'));
    }
