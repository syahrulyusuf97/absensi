...
<html lang="en">
<head>
<title>Absensi Karyawan | @yield('title')</title>
  <meta charset="UTF-8" />
...
<body class="hold-transition skin-blue fixed sidebar-mini">
  ...
  <div class="wrapper">
    ...
    @include('layouts.karyawanLayout.karyawanHeader')

    @include('layouts.karyawanLayout.karyawanSidebar')
    ...
    @include('layouts.karyawanLayout.karyawanFooter')
