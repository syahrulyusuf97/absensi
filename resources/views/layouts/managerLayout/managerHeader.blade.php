				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							...
							<p>
								{{ auth()->user()->name }}
								<small>@if(auth()->user()->level == 1) Manager @elseif(auth()->user()->level == 2) Karyawan @endif</small>
							</p>
						</li>
						<!-- Menu Footer-->
						<li class="user-footer">
							<div class="pull-left">
								<a href="{{ url('/manager/profil') }}" class="btn btn-default btn-flat" data-turbolinks="true">Profil</a>
							</div>
