...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="{{ url('/hrd/dashboard') }}" data-turbolinks="true">
          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
        </a>
      </li>
      <li>
        <a href="{{ url('/hrd/absensi') }}" data-turbolinks="true">
          <i class="fa fa-list-alt"></i> <span>Absensi</span>
        </a>
      </li>
      <li>
        <a href="{{ url('/hrd/izin') }}" data-turbolinks="true">
          <i class="fa fa-list"></i> <span>Izin Sakit/Cuti</span>
        </a>
      </li>
      <li>
        <a href="{{ url('/hrd/laporan') }}" data-turbolinks="true">
