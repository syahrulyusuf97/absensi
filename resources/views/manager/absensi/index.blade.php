        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box box-primary">
				...
				<div class="box-body table-responsive">
					<table id="table_absen_manager" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th>Tanggal</th>
								<th>Karyawan</th>
...
<script type="text/javascript">
    let table_absen_manager;

    $(document).on('turbolinks:load', function(){
        table_absen_manager = $('#table_absen_manager').dataTable({
			"processing": true,
			"serverSide": true,
			"destroy": true,
			"ajax": "{{ route('managerGetKaryawanDataAbsen') }}",
			"columns":[
				{"data": "tanggal_absen"},
				{"data": "karyawan"},
				{"data": "jenis_absen"},
	...
	function refreshTable() {
		table_absen_manager.api().ajax.reload();
	}
</script>
@endsection