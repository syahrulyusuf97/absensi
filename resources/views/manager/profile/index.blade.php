        ...
        <div class="col-xs-12">
            ...
            <div class="col-md-12 box box-primary">
                <div class="col-md-4 box-body box-profile">
                    ...
                    <p class="text-muted text-center text-capitalize">manager</p>
                ...
                <div class="col-md-6 box-body box-profile">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item"><b>NIP</b> <a class="pull-right">{!! auth()->user()->nip !!}</a></li>
            ...
            <div class="col-md-12 box box-primary">
                <div class="box-body">
                    <strong>
                        <i class="fa fa-pencil-square-o margin-r-5" id="isnip"></i>
                        <a href="javascript:void(0)" onclick="visibleNIP()">Sunting NIP</a>
                    </strong>
                    <div style="display: none" id="edit_nip">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/manager/profil/update-nip')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="title" class="col-sm-2 control-label">NIP</label>

                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="nip" name="nip" placeholder="Nama pengguna..." value="{!! auth()->user()->nip !!}">
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                    ...
                    <div style="display: none" id="edit_nama">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/manager/profil/update-nama')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_email">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/manager/profil/update-email')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_username">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/manager/profil/update-username')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none" id="edit_password">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/manager/profil/update-password')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none" id="edit_ttl">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/manager/profil/update-ttl')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_alamat">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/manager/profil/update-alamat')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
    ...
    <div class="modal modal-primary fade" id="foto-profil">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{url('/manager/profil/update-foto')}}" enctype="multipart/form-data">{{csrf_field()}}
...
<script type="text/javascript">
    ...
    var displayNIP = false, displayNama = false, displayEmail = false, displayUsername = false, displayPassword = false, displayTtl = false, displayAlamat = false;

    function visibleNIP() {
        if (displayNIP == false){
            $("#edit_nip").show('slow');
            displayNIP = true;
            $("#isnip").addClass("text-blue");
        } else {
            $("#edit_nip").hide('slow');
            displayNIP = false;
            $("#isnip").removeClass("text-blue");
        }
    }
