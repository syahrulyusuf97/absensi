        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box box-primary">
				...
				<div class="box-body table-responsive">
					<table id="table_izin_hrd" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th>Tanggal</th>
								<th>Jenis Izin</th>
...
<script type="text/javascript">
    ...
    $(document).on('turbolinks:load', function(){
        table_izin_hrd = $('#table_izin_hrd').dataTable({
			"processing": true,
			"serverSide": true,
			"destroy": true,
			"ajax": "{{ route('getHRDDataIzin') }}",
			"columns":[
				{"data": "tanggal_izin"},
				{"data": "jenis_izin"},
				{"data": "keterangan"},
	...
	function refreshTable() {
		table_izin_hrd.api().ajax.reload();
	}
</script>
@endsection