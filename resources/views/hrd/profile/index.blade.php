        ...
        <div class="col-xs-12">
            ...
            <div class="col-md-12 box box-primary">
                <div class="col-md-4 box-body box-profile">
                    ...
                    <p class="text-muted text-center text-capitalize">hrd</p>
            ...
            <div class="col-md-12 box box-primary">
                <div class="box-body">
                    ...
                    <div style="display: none" id="edit_nip">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/hrd/profil/update-nip')}}">{{ csrf_field() }}
                                <div class="box-body">
                    ...
                    <div style="display: none" id="edit_nama">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/hrd/profil/update-nama')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_email">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/hrd/profil/update-email')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_username">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/hrd/profil/update-username')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none" id="edit_password">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/hrd/profil/update-password')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none" id="edit_ttl">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/hrd/profil/update-ttl')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_alamat">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/hrd/profil/update-alamat')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
    ...
    <div class="modal modal-primary fade" id="foto-profil">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{url('/hrd/profil/update-foto')}}" enctype="multipart/form-data">{{csrf_field()}}
